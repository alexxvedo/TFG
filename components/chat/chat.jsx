...
export default function Chat({
  ...
  useEffect(() => {
    if (textareaRef.current) {
      // Resetear a altura mínima antes de calcular
      textareaRef.current.style.height = "24px";

      // Solo crecer si el contenido lo requiere
  ...
  return (
    <div className="flex flex-col h-full">
      <Card className="flex-1 bg-gradient-to-b from-background to-background/50 shadow-xl border-primary/10">
        <CardContent className="flex flex-col h-full p-0">
                ...
                <AnimatePresence initial={false}>
                  {chatMessages.map((msg, index) => (
                    <motion.div
                      ...
                      className={`flex items-start space-x-2.5 mb-4 ${
                        msg.isSelf
          ...
          <div className="flex-none border-t border-primary/10 bg-background/80 backdrop-blur-sm">
            <div className="p-4">
